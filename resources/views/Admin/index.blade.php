       ...
       <form action='' method='post'>
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='id matpel' id="matpel">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="nama matpel" class="col-sm-2 col-form-label">Mata Pelajaran</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='nama matpel' id="nama matpel">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-3">ID Mata Pelajaran</th>
                            <th class="col-md-4">Mata Pelajaran</th>
                            <th class="col-md-2">Link Video</th>
